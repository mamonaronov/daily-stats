"""Periodic jobs: billing, backup, telegram backup, cleanup."""
...
async def wake_reminder_job(repo: Repo, bot: Bot) -> None:
    try:
        from services.wake_reminders import send_wake_up_reminders
