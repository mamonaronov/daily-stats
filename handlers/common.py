...
BOT_PURPOSE = (
    ...
    "сигареты, снюс, сон, кофеин, алкоголь, активность, свои метрики и метки.\n\n"
    "На главном экране — сегодня. Статистика, графики и история собираются сами. "
    "Пишете, когда сами вспомните."
)
