...
def test_colon_block_aligns_parentheses():
    text = colon_block(
        [
            ("0–100 мс", "8 ч 32 мин 50 с (35,6%)"),
            ("100–500 мс", "4 ч 39 мин (19,4%)"),
            ("500–1000 мс", "1 ч 1 мин (4,2%)"),
            ("> 1000 мс", "19 мин (1,3%)"),
            ("Нет пинга/соединения", "9 ч 20 мин 30 с (38,9%)"),
            ("сервис не запущен", "8 мин (0,6%)"),
            ("сервер выключен", "0 с (0,0%)"),
        ]
    )
    rows = text.splitlines()
    assert rows == [
