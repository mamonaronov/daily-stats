...
def test_telegram_proxy_from_env(monkeypatch):
    monkeypatch.setenv("BOT_TOKEN", "1:test")
    monkeypatch.setenv("OWNER_TELEGRAM_ID", "1")
    monkeypatch.setenv("TELEGRAM_PROXY_URL", "socks5://127.0.0.1:10808")
    monkeypatch.setattr("config.load_dotenv", lambda: None)
    assert load_config().telegram_proxy_url == "socks5://127.0.0.1:10808"
...
def test_bot_session_socks5():
    ...
    session = _bot_session("socks5://127.0.0.1:10808")
